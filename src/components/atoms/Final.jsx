            ...
            <div className="w-screen h-screen bg-white text-black">
                <div className="grid grid-cols-2 p-14">
                    ...
                    <div className="col-span-1">
                        <ul>
                            <li>
                                Gracias por haber visitado mi portfolio, esto abierto a nuevos desafios y a seguir creciendo, si tenes algun projecto en mente, nos pongamos en contacto y hagamos de ese proejcto una realidad.
                            </li>
                            <li>
