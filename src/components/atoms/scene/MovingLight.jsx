...
export default function MovingLight({ position }) {
  ...
  useEffect(() => {
    ...
    if (
      ligthStrRef1.current !== undefined &&
      ligthStrRef2.current !== undefined &&
      ligthStrRef3.current !== undefined
    ) {
      mytimeline
        .fromTo(
          theGroupRef.current.position,
          { z: -20 - position[2] },
          { z: -1400, duration: 2 },
          0
        )
        .fromTo(
          ligthStrRef1.current,
          { intensity: 0 },
          { intensity: 1850, duration: 0.75 },
          0
        )
        .fromTo(
          ligthStrRef2.current,
          { intensity: 0 },
          { intensity: 1850, duration: 0.75 },
          0
        )
        .fromTo(
          ligthStrRef3.current,
          { intensity: 0 },
          { intensity: 1850, duration: 0.75 },
          0
        )
        .to(ligthStrRef1.current, { intensity: 0, duration: 0.25 }, 0.75)
        .to(ligthStrRef2.current, { intensity: 0, duration: 0.25 }, 0.75)
        .to(ligthStrRef3.current, { intensity: 0, duration: 0.25 }, 0.75)
        .fromTo(material.current.color, { b: 0 }, { b: 15, duration: 0.75 }, 0)
        .fromTo(material.current.color, { b: 0 }, { b: 15, duration: 0.75 }, 0)
        .fromTo(material.current.color, { b: 0 }, { b: 15, duration: 0.75 }, 0)
        .to(material.current.color, { b: 0, duration: 0.25 }, 0.75)
        .to(material.current.color, { b: 0, duration: 0.25 }, 0.75)
        .to(material.current.color, { b: 0, duration: 0.25 }, 0.75);
    }
  }, []);
