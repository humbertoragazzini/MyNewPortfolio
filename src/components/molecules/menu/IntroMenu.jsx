    ...
    <>
      {!isAcepted && (
        <section
          ...
          } orbitron p-9 fixed top-0 left-0 bg-[rgba(0,0,65,1.0)] z-[10000] backdrop-blur-md transition-all duration-500 ease-initial trans h-[100dvh] w-screen flex flex-col justify-center items-center overflow-hidden`}
        >
